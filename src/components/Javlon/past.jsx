...
const Javlon = () => { 
  return (
    <div>
      ...
      <div className='d-flex justify-content-center gap-4 mt-5  joylashuv'>
      ...
      <div className='mt-5'>
        ...
        <div className='container qar ms-5  d-flex'>
           <img width={'60px'} src="https://s3-alpha-sig.figma.com/img/9c61/c68b/21584b38838ff4fb0e6af4269f3ab471?Expires=1708905600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=oCWhyrs7k-BLuRI6laVH7OwfKadrfBOorbv-j3Cerrhvk3qj-cXcYJ7LRIDGMsgGALgMR6Led3uh6Ce7sTTQ0CDE0x3N~t~rm5ZaAu3Ek5wQ823qfXNfqYV1xMrAtbDfbWkEEc2esVzhCSx-y-dkxs5mzGspkNaL3tcjREcBOLFr6eC0JEnpeNPtiPNTjSPLgcTmuPhkrwvMlmAtzfSn8VmCRC71hpqHwhpu9iGmLgt9Ov8mYiuayIcWjbWnHj4yJFfja91fumApMUlDeJ~BvvlNXlzRpuqR6lw2zlq-GbaseCl01XJLrOX4cBoIbLaJYNFcI23mSl6iF8-04KPC0w__" alt="" />
           <h6 className='mt-1 qar1'>Любая удобная для вас форма оплаты<br></br> (нал/безнал, банковский перевод)</h6>
        </div> 
        </div>
        <div className='d-flex qar container mt-2'>
         <div className='container  d-flex'>
           <img width={'60px'} src="https://s3-alpha-sig.figma.com/img/adfc/a107/278b23216d96254feefd0a41e0025ecf?Expires=1708905600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=K1VjtVKaTYgaphr9ZDMGTuh6ITRGmg17932AjS3bNCmJmrbIgCy1twt4oM2qf5AX4q2e6IEg5pzHSElr4DHS6B4dHdPz59rw5gAHPRC~xnpK3kVnZNkagxuVplxbuVsimoGuyS~u~AxBoQDox5ldoyI0B8rgCPALE3~pfNGg~FGHHPzVNfmUkaOMpK2vxGrhntZ85Sz4MBro5N2cglLa~LleDS~gX4l0Ngb3ZFh~LlB9VOa0ySAAFy1kf6ATyuKrYRW703yjaqdBJ9~wTpAknjD0WXrQTCXFZBF~Gn8CWTRHkA4Nqu4raCb-90el~jdL95nqlgPTwIFb8fju00D2OA__" alt="" />
           <h6 className='mt-1 qar1'>Любая удобная для вас форма оплаты (нал/безнал, банковский перевод)</h6>
        </div> 
        <div className='container qar ms-5  d-flex'>
           <img width={'60px'} src="https://s3-alpha-sig.figma.com/img/2040/c5f9/27bb32e222a8bfb9e3b666aca7cf4fa0?Expires=1708905600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=EiQr2oBIJi4LVSf9Kf~DVIIZn2jVtARpiQO6qFfDiugV7N3ThHhyqvNhnwJ-GBFW8K4OdrFN8NcNbUF-bk4HUYtctwVL5voLfuDVn3CzC6s8A25dCPzOhIfkFB6TOPJbNJSziYm3OlxT4PMfwME7z3prxU17frk8mmxGsD2eQkOTZ3TYYZaQtAggUGJYdix0OsKhRKtQ0v0HL-EmCb6k3e0GiPJHYh1lO8VFbQbSP1-FAWQoB2tXrcR26oTpDLAqjaBQtXT40yY-N5W91umWPf6XXIXFEO7Aka9KM0JNR-Je8DKiD9Cxh56dAClufKfkKeHNGYRI4xRh9fWArwm2kg__" alt="" />
           <h6 className='mt-1 qar1'>Все наши автомобили застрахованы по<br></br> ОСАГО И КАСКО</h6>
        </div> 
        </div>
         <div className='d-flex qar container mt-2'>
          <div className='container   d-flex'>
           <img width={'60px'} src="https://s3-alpha-sig.figma.com/img/4e07/c08e/d583b29452710c1c987b986cb56b821a?Expires=1708905600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=Z-UhLJb6hBPnaILgZlqkJwn4t7rP38MQvhKAIIpQAfa~VRaOLfcwMtAlB3tPcAv0yrfxtiySdhE5KgsPyofixFskF8UkKvqmiOJLDRE-IP2CdaTqSvCyLRXaodi~JORBD5L6hfNHN3s8zNiYBWRJSnwl9wTzMKVDCyZazS~-0if4xFcbqqnl8jJ~ELH4HTLwC4v5wF86B5RXpZTad6yBCBfbV2B78Kudiu-n2m3QO47VGhXfyONwSjzSoe38XIUSf7dOOAJJz2tOZXC1rY7sk4nddnv4cRcAq8WPzsiWy3A4ItYvbT39o~zZBVcx4kUdskTgihSz01EeE8SEVhAnbA__" alt="" />
           <h6 className='mt-1 qar1'>Все наши автомобили застрахованы по<br></br> ОСАГО И КАСКО</h6>
         </div> 
         <div className='container qar ms-5 d-flex'>
           <img width={'60px'} src="https://s3-alpha-sig.figma.com/img/bd82/b7c8/1cf46b785e131049bf93f042b8e5b9bb?Expires=1708905600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=B2CGLUdxdfNOnkY63~qeHIH37Rw3~sddX-~pH0VTivE0wjEgTpwgUdnA1S2xlglWtoQ~l0XGkDXELbak1RcgjFl8t8Oren5yoCi2Vl5T0DHj-L4FNsrH7E5Dz1dtpSjDm8OrKyBa9e1jFfofO6-rDExzVfeTBMdLo30c3ib0jXmTfOOuiEGDdCx5jeUZl1dHqWdKnbi1KDh5Oh6LiGkK9JZUZfA4bwMyRK14udk-fZtEDwXD~nopmeoH~attHOGc-gv3tF9ZWpeAYYR~SkFJzNq6gWCsBDjs7ICzyPHz-AHSS6g~53HVNNDl5UvLbqYtluvX2x1qltoLOPvUbY49wQ__" alt="" />
           <h6 className='mt-1 qar1'>Все наши автомобили застрахованы по<br></br> ОСАГО И КАСКО</h6>
        </div> 
      </div>
